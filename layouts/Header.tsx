...
const Header = () => {
  ...
  return (
    <header className={"fixed w-full z-10 top-0 left-0 right-0 bg-zinc-300 dark:bg-zinc-600 dark:bg-gradient-to-r from-zinc-600 to-gray-500 "}>
      <div className={"flex items-center justify-between py-3"}>
        <div className={"flex"}>
          <div>
            <Link href={"/"} className="btn btn-ghost hover:bg-transparent">
              <Image src={isTheme === "light" ? chainbotBlack : chainbotWhite} alt="" width={200} height={200}
            ...
            <ul className={"flex space-x-1"}>
              <div className="navbar-center hidden lg:flex">
                <ul className=" flex px-1">
                  <li>
                    <div className="dropdown dropdown-hover dropdown-bottom">
                      ...
                      <ul tabIndex={0}
                        ...
                        <li className={"mt-0"}><Link href={"chatbot"}
                  ...
                  <li>
                    <Link href={links.chaincuet} target={"_self"}
                          className={"btn btn-ghost text-gray-600 dark:text-gray-200 hover:text-orange-800 dark:hover:text-orange-500"}>
