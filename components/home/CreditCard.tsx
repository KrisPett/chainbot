      ...
      <div className="bg-transparent min-h-screen flex justify-center items-center">
        <div className="space-y-16">
          <div className="w-96 h-56 m-auto bg-red-100 rounded-xl relative text-white shadow-2xl transition-transform transform hover:scale-110">
            <Image className="relative object-cover w-full h-full rounded-xl" src="https://i.imgur.com/kGkSg1v.png"
            ...
            <div className="w-full px-8 absolute top-8">
              <div className="flex justify-between">
                ...
                <Image className="w-14 h-14" src="https://i.imgur.com/bbPHJVe.png" alt={"alt"} width={100} height={100}/>
              </div>
              <div className="pt-1">
