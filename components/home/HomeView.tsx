      ...
      <div className={"flex xxs:flex-col lg:flex-row justify-center xl:gap-x-64"}>
        <section className={"mt-20"}>
          ...
          <div className={"w-full mt-20 flex justify-center"}>
            ...
            from-zinc-300 to-zinc-200 dark:bg-transparen dark:from-transparent dark:to-orange-1100 dark:text-gray-300
            border-zinc-300 dark:border-amber-900 dark:hover:text-white dark:group-hover:to-orange-400 normal-case inline-flex justify-center
